...
@interface MainChatViewController () <UIAlertViewDelegate, IChatManagerDelegate>
{
...
- (void)setupSubviews
{
    ...
    [self.tabBar setBackgroundColor:[UIColor colorWithRed:4246255.0 green:246/255.0 blue:246/255.0 alpha:1]];
    ...
    self.viewControllers = @[_contactsVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
...
-(void)unSelectedTapTabBarItems:(UITabBarItem *)tabBarItem
{
    [tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                        [UIFont systemFontOfSize:14], UITextAttributeFont,[UIColor colorWithRed:139/255.0 green:139/255.0 blue:139/255.0 alpha:1],UITextAttributeTextColor,
...
-(void)selectedTapTabBarItems:(UITabBarItem *)tabBarItem
{
    [tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                        ...
                                        UITextAttributeFont,[UIColor colorWithRed:42/255.0 green:173/255.0 blue:128/255.0 alpha:1],UITextAttributeTextColor,
...
- (void)setupUntreatedApplyCount
{
    ...
    if (_contactsVC) {
        if (unreadCount > 0) {
            _contactsVC.tabBarItem.badgeValue = [NSString stringWithFormat:@"%ld",(long)unreadCount];
        }else{
