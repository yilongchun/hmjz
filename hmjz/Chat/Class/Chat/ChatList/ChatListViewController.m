...
//好友列表列表
- (void)addFriendAction2
{
    if (_friendListController == nil) {
        _friendListController = [[AddFriendViewController alloc] initWithStyle:UITableViewStylePlain];

    }
    [self.navigationController pushViewController:_friendListController animated:YES];
}
